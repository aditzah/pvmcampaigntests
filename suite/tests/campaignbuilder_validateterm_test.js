...
Scenario('Validate Campaign Term', function*(I) {
	...
	I.wait(1);
	//Insert product code
	I.fillField('//*[@id="codesUrl"]', '073390005788');
	I.waitForElement('//*[@id="retailersDiv"]/label/input');
	//Select retailer
	I.checkOption('//*[@id="retailersDiv"]/label[2]/input','AmazonUS');
	...
	I.see('testcontent', '//*[@id="results"]/table/tbody');
